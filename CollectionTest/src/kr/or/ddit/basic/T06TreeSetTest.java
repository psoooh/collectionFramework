...
public class T06TreeSetTest { //Tree는 자료가 정렬하면서 들어간다-- 검색속도가 빠르다
	public static void main(String[] args) {
		...
		for (char ch = 'A'; ch <='Z'; ch++) {
			String temp = String.valueOf(ch); //문자열로 만들어 데이터 입력
			abcList.add(temp);
		}
		...
		//subSet(기준값1, 논리값1, 기준값2, 논리값2) => 각 기준값을 포함할지 여부를 설정한다(논리값이 true이면 포함)
